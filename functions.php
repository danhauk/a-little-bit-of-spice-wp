...
function a_little_bit_of_spice_scripts() {
	wp_enqueue_style( 'a-little-bit-of-spice-style', get_stylesheet_uri() );

	wp_enqueue_script( 'a-little-bit-of-spice-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'a-little-bit-of-spice-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
